...
void Adafruit_SSD1306::printAlignmentCenter(String dataString, byte xSize, byte ySize, byte spacee){
  String header[3] = {"", "", ""};
  String footer[3] = {"", "", ""};
  printAlignmentCenter(dataString, header, footer, xSize, ySize, spacee);
}
...
/*!
    ...
    */
/**************************************************************************/
void Adafruit_SSD1306::printAlignmentCenter(String dataString, String headerOrFooter[], byte xSize, byte ySize, byte spacee, bool noFooter){
  if (noFooter){
    String footer[3] = {"", "", ""};
    printAlignmentCenter(dataString, headerOrFooter, footer, xSize, ySize, spacee);
  }
  else{
    String header[3] = {"", "", ""};
    printAlignmentCenter(dataString, header, headerOrFooter, xSize, ySize, spacee);
  }
}
...
/*!
    ...
    */
/**************************************************************************/
void Adafruit_SSD1306::printAlignmentCenter(String dataString, String header[], String footer[], byte xSize, byte ySize, byte spacee){
  //  parse raw data
  byte i = 0;
  byte dataNow = 0;
  byte jumlahData = 1;
  ...
  byte xCoord[jumlahData];
  byte yCoord[jumlahData];
  String text[jumlahData];
